...
-- example of multiplying values in two columns using alias total and selecting on it
-- 667 rows

SELECT InvoiceId,    Description,    Price,    Quantity,    Price * Quantity,    ServiceDate
